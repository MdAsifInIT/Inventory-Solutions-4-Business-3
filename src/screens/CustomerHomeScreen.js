        ...
        >
            ...
            <View className="p-4">
                <View className="flex-row justify-between items-start">
                    ...
                    <Text className="text-lg font-bold text-indigo-600">₹{item.basePrice}/day</Text>
                </View>
                <View className="flex-row mt-3 items-center">
                    <View className={`px-2 py-1 rounded-full ${item.totalStock > 0 ? 'bg-green-100' : 'bg-red-100'}`}>
                        <Text className={`text-xs font-medium ${item.totalStock > 0 ? 'text-green-800' : 'text-red-800'}`}>
